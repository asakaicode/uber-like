...
export type ActiveDeliveryQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveDeliveryQuery = { myActiveDelivery: { id: string, status: string, order: { id: string, status: OrderStatus, deliveryLat: number, deliveryLng: number, restaurant: { name: string, lat: number, lng: number } } } | null };
